...
4. **Finish the remaining OAuth provider depth** (GitHub, GitLab, Slack,
   ...
   calendar event lifecycle are now wired, and Trello now has fixed-board/list
   task list/create routes; Linear issue writes remain the reference for a
...
- Backend: `uv run pytest tests/ -q` (574 passing, 13 skipped, verified
  2026-09-07).
