...
CATALOG: list[CatalogSpec] = [
    ...
    CatalogSpec(
        id="snapchat",
        name="Snapchat",
        description="Verify a Snapchat Marketing API organization and list accessible ad accounts.",
        category=ConnectorCategory.OTHER,
        connector_type=ConnectorType.OAUTH,
        icon="Ghost",
        auth_type=ConnectorAuthType.OAUTH2,
        capabilities=["Verify marketing account", "List ad accounts"],
        canonical_capabilities=["identity.account.read", "ads.account.list"],
