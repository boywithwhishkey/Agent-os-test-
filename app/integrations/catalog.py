...
CATALOG: list[CatalogSpec] = [
    ...
    CatalogSpec(
        ...
        capabilities=["Trigger workflow", "Pass payload"],
        canonical_capabilities=["automation.workflow.trigger"],
        popular=True,
    ...
    CatalogSpec(
        id="github",
        name="GitHub",
        description="Read repositories and approval-create GitHub issues through a connected account.",
    ...
    CatalogSpec(
        id="gitlab",
        name="GitLab",
        description="Read repository metadata and content through a connected account.",
        category=ConnectorCategory.DEVELOPER,
        connector_type=ConnectorType.OAUTH,
        icon="GitBranch",
        auth_type=ConnectorAuthType.OAUTH2,
        capabilities=["Connect account", "Verify identity", "Read repository metadata", "Read repository content"],
        canonical_capabilities=[
            "identity.account.read",
            "repo.metadata.read",
            "repo.content.read",
    ...
    CatalogSpec(
        id="whatsapp",
        name="WhatsApp Cloud",
        description="Connect a WhatsApp Business phone and send governed text or template messages.",
        category=ConnectorCategory.PRODUCTIVITY,
        connector_type=ConnectorType.OAUTH,
        icon="MessageCircle",
        auth_type=ConnectorAuthType.OAUTH2,
        capabilities=["Verify business phone", "Send text message", "Send template message"],
        canonical_capabilities=[
            "identity.account.read",
            "chat.message.send",
            "chat.template.send",
    ...
    CatalogSpec(
        id="instagram",
        name="Instagram",
        description="Connect an Instagram professional account, message users, and publish image posts.",
        category=ConnectorCategory.PRODUCTIVITY,
        connector_type=ConnectorType.OAUTH,
        icon="Instagram",
        auth_type=ConnectorAuthType.OAUTH2,
    ...
    CatalogSpec(
        id="notion",
        name="Notion",
        description="Search, read, and approval-create Notion pages through a connected workspace.",
        category=ConnectorCategory.PRODUCTIVITY,
        connector_type=ConnectorType.OAUTH,
        icon="FileText",
        auth_type=ConnectorAuthType.OAUTH2,
    ...
    CatalogSpec(
        id="google_sheets",
        name="Google Sheets",
        description="Read spreadsheet ranges and approval-append rows through a connected Google account.",
        category=ConnectorCategory.GOOGLE,
        connector_type=ConnectorType.OAUTH,
        icon="Table2",
        auth_type=ConnectorAuthType.OAUTH2,
        capabilities=["Read spreadsheet ranges", "Append rows"],
        canonical_capabilities=["identity.account.read", "data.record.read", "data.record.write"],
        popular=True,
    ...
    CatalogSpec(
        id="google_tasks",
        name="Google Tasks",
        description="List tasks and approval-create bounded tasks in Google Tasks.",
        category=ConnectorCategory.GOOGLE,
        connector_type=ConnectorType.OAUTH,
        icon="ListTodo",
        auth_type=ConnectorAuthType.OAUTH2,
        capabilities=["List tasks", "Create tasks"],
        canonical_capabilities=["identity.account.read", "productivity.task.list", "productivity.task.create"],
        popular=True,
        documentation_url="https://developers.google.com/workspace/tasks/reference/rest",
        implemented=True,
        requires=["GOOGLE_OAUTH_CLIENT_ID", "GOOGLE_OAUTH_CLIENT_SECRET"],
    ),
    CatalogSpec(
        ...
        description="Read contacts and approval-create bounded contacts through a connected Google account.",
        category=ConnectorCategory.GOOGLE,
        connector_type=ConnectorType.OAUTH,
        icon="Users",
        auth_type=ConnectorAuthType.OAUTH2,
        capabilities=["Read contacts", "Create contacts"],
        canonical_capabilities=["identity.account.read", "crm.contact.list", "crm.contact.create"],
        popular=True,
        documentation_url="https://developers.google.com/people",
        implemented=True,
        requires=["GOOGLE_OAUTH_CLIENT_ID", "GOOGLE_OAUTH_CLIENT_SECRET"],
    ),
    CatalogSpec(
        ...
        description="Read, draft, and approval-send Outlook mail; manage calendar events.",
        category=ConnectorCategory.PRODUCTIVITY,
        connector_type=ConnectorType.OAUTH,
        icon="MailCheck",
        auth_type=ConnectorAuthType.OAUTH2,
    ...
    CatalogSpec(
        ...
        description="List tasks and approval-create bounded Microsoft To Do tasks.",
        category=ConnectorCategory.PRODUCTIVITY,
        connector_type=ConnectorType.OAUTH,
        icon="ListTodo",
        auth_type=ConnectorAuthType.OAUTH2,
        ...
        canonical_capabilities=["identity.account.read", "productivity.task.list", "productivity.task.create"],
        popular=True,
        documentation_url="https://learn.microsoft.com/en-us/graph/todo-concept-overview",
        implemented=True,
        requires=["MICROSOFT_OAUTH_CLIENT_ID", "MICROSOFT_OAUTH_CLIENT_SECRET"],
    ),
    CatalogSpec(
    ...
    CatalogSpec(
        id="supabase",
        name="Supabase",
        description="Read and approval-write records in one configured Supabase table.",
        category=ConnectorCategory.DATA,
        connector_type=ConnectorType.API,
        icon="Flame",
        auth_type=ConnectorAuthType.API_KEY,
        capabilities=["Read records", "Write records"],
        canonical_capabilities=[
            "data.record.read",
            "data.record.write",
        ],
    ...
    CatalogSpec(
        id="trello",
        name="Trello",
        description="List cards and approval-create tasks on one configured Trello board/list.",
        category=ConnectorCategory.PRODUCTIVITY,
        connector_type=ConnectorType.API,
        icon="LayoutKanban",
        auth_type=ConnectorAuthType.API_KEY,
        capabilities=["Read account", "List cards", "Create card/task"],
        canonical_capabilities=["identity.account.read", "productivity.task.list", "productivity.task.create"],
        popular=True,
    ...
    CatalogSpec(
        id="zoom",
        name="Zoom",
        description="Read scheduled Zoom meetings and approval-create new meetings.",
        category=ConnectorCategory.PRODUCTIVITY,
        connector_type=ConnectorType.OAUTH,
        icon="Video",
        auth_type=ConnectorAuthType.OAUTH2,
        capabilities=["Connect account", "List meetings", "Create meeting"],
        canonical_capabilities=["identity.account.read", "meeting.session.list", "meeting.session.create"],
        popular=True,
    ...
    CatalogSpec(
        id="snapchat",
        name="Snapchat",
        description="Verify Snapchat marketing access, list ad accounts, and read public profiles.",
        category=ConnectorCategory.OTHER,
        connector_type=ConnectorType.OAUTH,
        icon="Ghost",
        auth_type=ConnectorAuthType.OAUTH2,
        capabilities=["Verify marketing account", "List ad accounts", "Read public profile"],
        canonical_capabilities=[
            "identity.account.read",
            "ads.account.list",
            "social.profile.read",
