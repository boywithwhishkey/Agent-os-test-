    ...
    <div className="relative">
      <Tooltip content={configured ? "Operator session" : "No operator session"}>
        <button
          ...
          aria-haspopup="menu"
          aria-expanded={open}
          className="focus-ring relative flex h-8 w-8 shrink-0 items-center justify-center rounded-full glass-soft border border-hairline text-content-secondary transition-colors hover:text-accent-violet"
        >
          <CircleUserRound className="h-4.5 w-4.5" />
          <span
            className={cn(
