    ...
    <div className="space-y-6">
      ...
      <Card className="border-accent-blue/25 bg-accent-blue/5">
        <CardContent className="flex items-start gap-3 pt-5">
          ...
          <p className="text-sm text-content-secondary">
            ...
            <Link to="/orchestrate" className="font-medium text-accent-blue hover:underline">
              orchestration
            </Link>{" "}
            or an{" "}
            <Link to="/autonomous" className="font-medium text-accent-blue hover:underline">
              autonomous run
            </Link>{" "}
      ...
      <Card>
        ...
        <CardContent>
          ...
          <Link
            to="/autonomous"
            className="mt-3 inline-flex items-center gap-1 text-sm font-medium text-accent-violet hover:underline"
          >
